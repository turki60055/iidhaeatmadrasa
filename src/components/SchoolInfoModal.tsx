      ...
      <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden my-8 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 text-white p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold">بيانات المدرسة والترويسة الرسمية</h2>
          ...
          <div className="flex flex-wrap gap-2">
            {MINISTRY_PRESETS.map((preset, idx) => (
              <button
                ...
                className="text-xs px-2.5 py-1 rounded-lg bg-white border border-slate-200 text-slate-700 hover:border-emerald-500 hover:text-emerald-700 hover:bg-emerald-50 transition shadow-xs font-medium cursor-pointer"
              >
                {preset.country}
              </button>
            ))}
        ...
        <form onSubmit={handleSave} className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="مثال: المملكة العربية السعودية - وزارة التعليم"
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 text-sm outline-none transition"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="مثال: مدرسة روّاد المستقبل النموذجية"
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 text-sm font-bold text-slate-900 outline-none transition"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 text-sm outline-none transition bg-white"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="أ. عبد الرحمن السعدي"
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:border-emerald-500 text-sm outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="أ. خالد بن محمد المنصور"
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:border-emerald-500 text-sm outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="عبد الله بن خالد التميمي"
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:border-emerald-500 text-sm outline-none"
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-slate-800 border-b border-slate-100 pb-2 flex items-center gap-2">
              ...
              شعار المدرسة في النماذج الرسمية
            </h3>
              ...
              {SCHOOL_EMBLEMS.map((emblem) => {
                ...
                return (
                  <button
                    ...
                    className={`p-3 rounded-2xl border text-center transition flex flex-col items-center gap-2 cursor-pointer ${
                      isSelected
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold leading-tight">{emblem.name}</span>
                  </button>
                );
              })}
            </div>
          ...
          <div className="pt-4 border-t border-slate-200 flex items-center justify-end gap-3">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2.5 rounded-xl text-slate-600 hover:bg-slate-100 text-sm font-medium transition cursor-pointer"
            >
              إلغاء
            </button>
            <button
              type="submit"
              className="px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm shadow-md shadow-emerald-600/20 transition flex items-center gap-2 cursor-pointer"
            >
              {savedSuccess ? (
                <>
